...
import Productive from "@/components/organisms/Productive";
import Retail from "@/components/organisms/Retail";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <Text
        ...
        classNameSubHeader="text-lg font-merriweather md:text-xl lg:text-2xl mt-4 text-teal-700 italic font-serif tracking-wide"
      />
      </div>
      
      <div className="flex justify-center items-center w-full max-w-5xl mt-[120px]">
        <Video
          path={
